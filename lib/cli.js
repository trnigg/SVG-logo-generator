        ...
        this.svgQuestions = [
            {
                type: 'input',
                name: 'chosenText',
                message: 'Please enter up to 3 characters/initials (case-sensitive) for your logo:',
            ...
            },
            {
                ...
                default: 'logo',
                // NOTE validate is required despite setting default to 'logo' (which becomes logo.svg in render-svg.js) because entering 'space' can override this.
            },
        ]
    }


    // FUNCTION to tidy/format responses for better handling in the rendering phase
