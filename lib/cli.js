    ...
    constructor() {
        ...
        this.svgQuestions = [
            ...
            },
            {
                type: 'input',
                name: 'chosenFilename',
                message: 'Please provide a name for your logo: (This will be used as the filename for your generated SVG)',
                validate: (chosenFilename) => (chosenFilename.length ? true : 'Cannot be left blank. Please enter a name for your SVG file.'),
            },
        ]
    }
            ...
            .then((confirmResponse) => {
                ...
                if (confirmResponse.confirmedInstructions) {
                    ...
                    inquirer
                        ...
                        .then((responses) => renderLogo(responses));
